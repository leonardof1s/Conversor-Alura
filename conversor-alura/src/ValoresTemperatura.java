...
public class ValoresTemperatura {
	...
	public ValoresTemperatura() {
		...
		try {
			...
			String temperatura = JOptionPane.showInputDialog(null, "Escolha à escala de ValoresTemperatura:",
					"Escalas de ValoresTemperatura", JOptionPane.PLAIN_MESSAGE, null, temperaturas, null).toString();
